...
void GAS::Iteration()
{
    ...
    for (int i = 0; i < params.skip_frames; i++)
    {
        IterateSwarm();
    }
    ...
    while (SDL_PollEvent(&e))
    {
        ...
        case SDL_KEYDOWN:
            ...
            case SDLK_s:
                ...
                break;
            case SDLK_q:
                state.bold_points = !state.bold_points;
                key_pressed = 1;
                break;
            case SDLK_b:
            ...
            case SDLK_v:
                ...
                break;
            case SDLK_y:
                std::cout << ((state.printer = !state.printer) ? "\nPrinter On" : "\nPrinter Off");
                key_pressed = 1;
                break;
            ...
            case SDLK_m:
                ...
                break;
            case SDLK_w:
                state.display_swarm = !state.display_swarm;
                key_pressed = 1;
                break;
            case SDLK_e:
                state.display_line = !state.display_line;
                key_pressed = 1; /* params.clear_curve_spline(); */
                break;
            case SDLK_l:
                state.update_line = !state.update_line;
                key_pressed = 1;
                break;
            case SDLK_f:
                main_swarm.Toggle_Fill();
                std::cout << "\n- Toggle Fill";
                break;
            case SDLK_c:
                input.print_step = true;
                break;
                break;
            case SDLK_g:
                input.print_grid = true;
                break;
            case SDLK_d:
                input.print_denisty = true;
                break;
            case SDLK_x:
            ...
            case SDLK_k:
                ...
                break;
            case SDLK_o:
                params.only_positive_curve = !params.only_positive_curve;
                break;
            case SDLK_i:
                input.update_curve = true;
                break;
            case SDLK_u:
                key_pressed = 1;
                // params = Params();
...
void GAS::IterateSwarm()
{
    ...
    if (input.set_burn)
        main_swarm.BurnSegmentByPoint(burn_x, burn_y);
    if (input.lights_out)
        main_swarm.LightsOut();
    if (input.clear)
        main_swarm.EraseParticles();
...
void GAS::DrawScreen()
{
    ...
    if (state.display_swarm)
        screen.load_swarm(main_swarm.all_list, state.bold_points);
    if (state.blur)
        screen.box_blur();
...
void GAS::CalcFPS()
{
    ...
    if (delta < timePerFrame)
    {
        ...
        fps = 1000. / delta * params.skip_frames;
